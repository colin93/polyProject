...
int main(){
  ...
  polynomial *poly1 = createPoly(); //polynomial for performing various functions
  ...
  while (option!=8){
    ...
    case 3:
      ...
      polynomial *poly3 = polyAdd(poly1,poly2);
      printPoly(poly1);
      printf("+");
      printPoly(poly2);
      printf("=");
    ...
    case 4:
      ...
      printf("Create a second polynomial\n");
      polynomial *poly2 = createPoly();
      polynomial *poly3 = polySub(poly1,poly2);
      printPoly(poly1);
      printf("-");
      printPoly(poly2);
      printf("=");
    ...
    case 5:
      ...
      scanf("%lf",&mult);
      polynomial *poly2 = polyMultiply(poly1,mult);
      printPoly(poly1);
    ...
    case 6:
      ...
      scanf("%lf",&mult);
      polynomial *poly2 = polyDivide(poly1,div);
      printPoly(poly1);
    ...
    case 7:
      ...
      polynomial *poly2 = polyNormalise(poly1);
      printPoly(poly1);
      printf("\nNormalised is");
      printPoly(poly2);
      deletePoly(poly2);
